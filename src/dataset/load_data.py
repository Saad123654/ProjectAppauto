...
class Preprocessor:
    """Preprocess the data by deleting entries, adding new columns, converting to datetime and
    adding date infos.
    ...
    def add_entries(
        ...
        """Add new colums to the dataframe with new values. These values are combinations of
        existing columns.
